package xdroid.mwee.com.zmstudy.ui.view.tpie;
...
//        float mSin_1 = (float) Math.sin(Math.toRadians(1));
//        float outerRadius = getWidth()/2;
//        float dotRadius = mSin_1*outerRadius/(1+mSin_1);
//        Paint mSwipCirclePaint = new Paint();
//        mSwipCirclePaint.setAntiAlias(true);
//        mSwipCirclePaint.setStyle(Paint.Style.STROKE);
//        canvas.drawCircle(getWidth()/2,getHeight()/2-outerRadius+dotRadius,dotRadius,mSwipCirclePaint);
