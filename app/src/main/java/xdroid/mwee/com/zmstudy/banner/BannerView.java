...
//        });
    ...
    private void startScroll() {
        ...
        isStopScroll = false;
        subscription = Observable.interval(delayTime, TimeUnit.SECONDS)
                ...
                .subscribe(new Action1<Long>() {
                    ...
                    public void call(Long aLong) {
                        ...
                        System.out.println("BannerView 2秒定时任务");
                        if (isStopScroll) {
                            return;
                        }
//                        pos = pos % pointSize;
//                        currentPos = pos;
                        //isStopScroll = true;
                        viewPager.setCurrentItem((viewPager.getCurrentItem() % viewPager.getAdapter().getCount()) + 1);
                    }
                });
