...
/**
 * desc : 提供sunline 加签 加密 解密 验签操作
 * auther : yuss
 * email:yushuangsang@sunline.cn
 */
...
//                                            .newBuilder()
//
//                                            .addHeader("api_id", "API01")
//                                            .addHeader("version", "1.0")
//                                            .addHeader("app_id", "123456789")
//                                            .addHeader("app_secret", "123456")
//                                            .addHeader("sign_type", "SHA256")
//                                            .addHeader("timestamp", DateUtil.getCurrentDate(DateUtil.DATE_VISUAL14FORMAT))
//                                            .addHeader("id_token", "")
//                                            .build();
...
//                            })
     ...
     * @param callback
     */
    public static void doPost(String url, Map<String, String> params, final RespCallBack callback) throws Exception {
...
//            }
        ...
        //Log.d(TAG, "body " + SignType + "   " + body.toString());
        RequestBody requestBody = RequestBody.create(MediaType.parse("application/json; charset=utf-8"), body);


        String time = DateUtil.getCurrentDate(DateUtil.DATE_VISUAL14FORMAT);
        String str = "timestamp=" + time + "&apiId=" + "API01" + "&app_id=" + "123456789" + "&version=" + "1.0" + "&body=" + body;
        String sign = RSAUtil.sign(PrivateKey, str.getBytes());
...
//    }
    ...
    private static String decryptResponse(Response response) {
        try {
            ...
            String resStr = "";
            byte[] res = RSAUtil.decrypt(EdspClient.PrivateKey, strResponse);
...
//            }
            Log.d(TAG, "decryptResponse  " + resStr);
            return resStr;
        } catch (Exception e) {
            e.printStackTrace();
        }
