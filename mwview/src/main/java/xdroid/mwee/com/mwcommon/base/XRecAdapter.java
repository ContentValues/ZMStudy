...
import xdroid.mwee.com.mwcommon.callback.SimpleItemCallback;


public abstract class XRecAdapter<T, F extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<F> {
    ...
    public XRecAdapter(Context context, ItemCallback<T> callback) {
        this.context = context;
    ...
    public XRecAdapter(Context context, List<T> data, ItemCallback<T> callback) {
        this.context = context;
        this.data.clear();
        this.data.addAll(data);
        this.itemCallback = callback;
