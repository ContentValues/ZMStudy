...
import xdroid.mwee.com.mwcommon.kit.Codec;
...
public class DiskCache implements ICache {
    ...
    public void put(String key, String value, long expireMills) {
        ...
        try {
            ...
            content.append(TAG_CACHE.replace("createTime_v", "" + Calendar.getInstance().getTimeInMillis()).replace
                    ("expireMills_v", "" + expireMills));
