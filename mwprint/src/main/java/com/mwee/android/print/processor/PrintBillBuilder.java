...
//        col4Content = col4Content.trim();
    ...
    public void addLeftBigWithRight(String leftSmall, String leftBig, String rightSmall, int fontColor) {
        try {
            this.addText(leftSmall, 1, PrintDataItem.ALIGN_LEFT, 0, fontColor);
            this.addText(leftBig, 2, PrintDataItem.ALIGN_LEFT, 0, fontColor);

            this.addText(PrintStringUtil.padLeft(rightSmall, this.charSize - leftSmall.getBytes("GBK").length - leftBig.getBytes("GBK").length * 2, this.gbkSize) + "\n", 1, PrintDataItem.ALIGN_RIGHT, 0);
    ...
    public void addLeftWithRightBig(String leftString, String rightSmall, String rightBig, int fontColor) {
        ...
        try {
            this.addText(PrintStringUtil.padRight(leftString, this.charSize - rightSmall.getBytes("GBK").length - rightBig.getBytes("GBK").length * 2, this.gbkSize), 1, 0, 0, fontColor);
            this.addText(rightSmall, 1, PrintDataItem.ALIGN_RIGHT, 0, fontColor);
            this.addText(rightBig + "\n", 2, PrintDataItem.ALIGN_RIGHT, 0, fontColor);
        } catch (UnsupportedEncodingException e) {
            PrintLog.e("","",e);
        }
    }
